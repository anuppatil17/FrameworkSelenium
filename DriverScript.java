...
public class DriverScript {
	...
	@BeforeTest
	@Parameters({"device_ID","platformName","os_Version","bundleID","appPackage","appActivity","platform","user","password","url","datasheetloc","screenshotsloc","appType","appurl","appbrowser", "appname"})
	public void setupDriver(String device_ID,String platformName,String os_Version,String bundleID,String appPackage,String appActivity,String platform,String user,String password,String url,String datasheetloc,String screenshotsloc,String appType,String appurl,String appbrowser, String appname) throws MalformedURLException,NoSuchMethodException, SecurityException
	{
		try {
            ...
            sappname = appname;
			actionKeywords.setMethod(sDevice_ID,splatformName,sOS_Version,sbundleID,sappPackage,sappActivity,splatform,suser,spassword,surl,sdatasheetloc,sscreenshotsloc,sappType,sappurl,sappbrowser, sappname);
    	 ...
    	 TreeMap m = new TreeMap();
			...
			
			{
				...
				//	  fileLocdir=Constants.Test_Execution_Screenshot_Loc+df.format(dateobj)+"\\"+sTestCaseID;
					...
					/*For Reporting */
					reporter.initTestCase(this.getClass().getName().substring(0,this.getClass().getName().lastIndexOf(".")), sTestCaseID, sTestCaseDesc, false);
				...
				//	sDevice_ID= ExcelUtils.getCellData(iTestStep, Constants.Col_DeviceID,Constants.Sheet_TestCases);
					...
					for (;iTestStep<iTestLastStep;iTestStep++)
					{
			    		...
			    		sInputParams1 = ExcelUtils.getCellData(iTestStep, Constants.Col_InputParams1, Constants.Sheet_TestSteps);
			    		...
			    		for(int i=0;i<method.length;i++){
			    			...
			    			//	System.out.println(x);
			    				...
			    				method[i].invoke(actionKeywords,sTestStepDesc,sObjectRef,sInputParams,sObjectType,bResult,sInputParams1);
